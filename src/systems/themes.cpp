...
void Themes::registerDefaultThemes() {
  ...
  m_themes.emplace("default", std::make_unique<ThemeObject>(values));
  ...
  m_themes.emplace("dark", std::make_unique<ThemeObject>(values));
  ...
  m_themes.emplace("sepia", std::make_unique<ThemeObject>(values));
